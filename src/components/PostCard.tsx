...
const PostCard: React.FC<PostCardProps> = ({ post, onLike, onEdit, onDelete, isOwner = false }) => {
      ...
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center space-x-6 mt-4">
            ...
            <button className="flex items-center space-x-2 px-3 py-1.5 rounded-full text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-all">
